    ...
    <table-contain :height.sync="table.maxHeight">
      ...
      <el-table
        ...
        <el-table-column label="序号" width="50" align="center">
         ...
         <el-table-column prop="supplierInfoName" label="供应商名称" align="center"></el-table-column>
        <el-table-column prop="orderNumber" label="涉及采购订单单数" align="center"></el-table-column>
...
import { fetchSupplierDimension } from '@/api/allReports/index.js'
...
export default {
  ...
  data() {
    return {
      searchBarData: [[
        ...
        { type: 'option', value: null, key: 'supplierInfoId', class: 'w150', placeholder: '供应商', options: [
          // { label: '启用', value: 1 },
          // { label: '禁用', value: 0 }
        ] },
        { type: 'search', name: '查询' },
  ...
  methods: {
    ...
    showAdd(item) {
      ...
      let url = 'cmm/procurementStatistics/exportSupplierExcel?'
      const data = {
        ...item
      }
    ...
    fecthSalerList() {
      fecthMemberSelect({ staffType: 10 }).then(({ data }) => {
