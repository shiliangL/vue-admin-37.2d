...
<!-- 全屏固定表头弹层组件 -->
  <div class="dialog-content">
    <el-dialog :visible.sync="dialog.visiable" @close="closeDialog" :show-close="false" :fullscreen="true" :modal-append-to-body="false" :modal="false" :close-on-press-escape="true">
            ...
            <div class="row-item">
                ...
                <div class="row-content view-header">
                  <el-row>
                    ...
                    <el-col :xs="24" :sm="10" :md="8" :lg="6">
                      <el-form-item label="申请换货时间:">
                       <span v-cloak>{{form.createTime}}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="10" :md="8" :lg="6">
                      <el-form-item label="换货审核同意时间:">
...
export default {
  ...
  methods: {
    ...
    fecthDetail() {
      ...
      returnChangeDetail({ id: this.data.obj.id, method: 2 }).then(({ data }) => {
