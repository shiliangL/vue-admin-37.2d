          ...
          <el-table-column label="序号" width="50" align="center">
            ...
            <template slot-scope="scope">
             ...
             <template slot-scope="scope">
              ...
              <el-tag  size="small" type="danger" v-if="scope.row.checkState === 2"> 报损 </el-tag>
              <el-tag  size="small" type="warning" v-if="scope.row.checkState === 3"> 报溢 </el-tag>
            </template>
          </el-table-column>
    ...
    return {
      ...
      searchBarDate: [
        [
          ...
          { type: 'date', value: null, key: 'updateTime', width: '200px', placeholder: '核查时间' },
          { type: 'option', value: null, key: 'stockId', class: 'w150', placeholder: '仓库', options: [] },
          { type: 'option', value: null, key: 'checkState', class: 'w150', placeholder: '核查状态', options: [
            { label: '正常', value: 1 },
            { label: '报损', value: 2 },
            { label: '报溢', value: 3 }
          ] },
