          ...
          <el-table-column label="序号" width="50" align="center">
            <template slot-scope="scope">
              <span>{{scope.$index + 1}}</span>
					...
					<el-table-column prop="orderNo" label="配送区域名称" align="center"></el-table-column>
					<el-table-column prop="stockInfoName" label="区域说明" align="center"></el-table-column>
					<el-table-column prop="storageType" label="所在城市" align="center"></el-table-column>
					<el-table-column prop="createdName" label="配送员" align="center"></el-table-column>
					<el-table-column prop="createdTime" label="关联客户" align="center"></el-table-column>
